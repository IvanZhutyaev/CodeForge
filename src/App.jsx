...
function App() {
  ...
  return (
    <div className="bg-[#10162A] min-h-screen text-white font-sans">
      {/* Header */}
      <header className="w-full fixed top-0 left-0 z-50 bg-[#0B1020] border-b border-[#23263A]">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
          {/* Logo */}
          <div className="flex items-center gap-2">
            <span className="text-2xl">🛠️</span>
            <span className="text-xl font-bold text-[#FF7E3F] tracking-wide">CodeForge</span>
          </div>
          {/* Navigation */}
          <nav className="hidden md:flex gap-7 text-gray-300 font-medium">
            {navLinks.map(link => (
              <a
                ...
                className="hover:text-[#FF7E3F] transition-colors duration-200"
              >
                {link}
              </a>
            ))}
          ...
          <div className="w-10 h-10 border border-[#23263A] rounded-lg flex items-center justify-center">
            <span className="text-[#FF7E3F]">✦</span>
          </div>
        </div>
      </header>
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center min-h-screen pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-6xl md:text-7xl font-extrabold text-[#FFB088] drop-shadow-lg mb-6 text-center">
            CodeForge
          </h1>
          ...
          <div className="flex gap-6">
            <a href="#portfolio" className="bg-[#FF7E3F] hover:bg-[#ff965f] text-white font-semibold px-8 py-3 rounded-lg text-lg shadow transition-all duration-200">
              View Portfolio
            </a>
            <a href="#contact" className="border border-[#FF7E3F] text-[#FF7E3F] hover:bg-[#FF7E3F] hover:text-white font-semibold px-8 py-3 rounded-lg text-lg transition-all duration-200">
              Contact Us
            </a>
          </div>
        </div>
      ...
      <section id="services" className="max-w-7xl mx-auto py-20 px-4">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-2">Our Services</h2>
        <div className="flex justify-center mb-12">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* 1 */}
          <div className="bg-[#181E36] rounded-xl p-7 shadow hover:shadow-lg transition flex flex-col items-start">
      ...
      <section id="portfolio" className="max-w-7xl mx-auto py-20 px-4">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-2">Our Portfolio</h2>
        <div className="flex justify-center mb-12">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* 1 */}
          <div className="bg-[#181E36] rounded-xl p-7 shadow flex flex-col items-start">
            ...
            <a href="#" className="flex items-center gap-2 text-[#FF7E3F] font-semibold hover:underline mt-auto">
          ...
          {/* 4 */}
          <div className="bg-[#181E36] rounded-xl p-7 shadow flex flex-col items-start md:col-span-1 col-span-3">
      ...
      <section id="team" className="max-w-7xl mx-auto py-20 px-4">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-2">Our Team</h2>
        <div className="flex justify-center mb-12">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-[#181E36] rounded-xl py-10 flex flex-col items-center shadow">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {['Python','JavaScript','React','Node.js','Flutter','Django','PostgreSQL','MongoDB','AWS','Docker','TensorFlow','GraphQL'].map(tech => (
            <span key={tech} className="bg-[#181E36] text-[#FF7E3F] px-6 py-2 rounded font-semibold text-base shadow border border-[#23263A]">
              {tech}
            </span>
          ))}
        </div>
      ...
      <section id="aboutus" className="max-w-4xl mx-auto py-20 px-4 text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-2">About Us</h2>
        <div className="flex justify-center mb-8">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <p className="text-gray-300 text-lg mb-10">
          We are CodeForge, a constellation of talented developers united like the stars of the blacksmith.<br/>
          Just as ancient smiths forged powerful tools under the night sky, we craft digital solutions guided by the creativity and precision of our cosmic inspiration. Our team draws strength from the constellation of the blacksmith, channeling its energy into every project we deliver.
        </p>
        ...
        <p className="text-gray-300 text-lg">
          Like the blacksmith who shapes metal with fire and hammer, we transform concepts into functional digital experiences through code and creativity. Our connection to this celestial pattern reminds us that true craftsmanship requires both technical precision and artistic vision.
        </p>
      </section>
      {/* Connect Section */}
      <section id="connect" className="max-w-5xl mx-auto py-20 px-4 text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-2">Connect With Us</h2>
        <div className="flex justify-center mb-8">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <p className="text-gray-300 text-lg mb-10">
          Join our community of stars in the digital cosmos. Follow us on social media for the latest updates, tips, and insights.
        </p>
        <div className="flex flex-col md:flex-row gap-8 justify-center mb-10">
          {/* Telegram */}
          <div className="bg-[#181E36] rounded-xl p-8 flex-1 flex flex-col items-center shadow">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center">
          <a href="#contact" className="bg-[#FF7E3F] hover:bg-[#ff965f] text-white font-semibold px-8 py-3 rounded-lg text-lg shadow transition-all duration-200 mb-4 md:mb-0">
            Contact Us Directly
          </a>
          <a href="#" className="border border-[#FF7E3F] text-[#FF7E3F] hover:bg-[#FF7E3F] hover:text-white font-semibold px-8 py-3 rounded-lg text-lg transition-all duration-200">
      ...
      <section id="testimonials" className="max-w-3xl mx-auto py-20 px-4 text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-2">What Our Clients Say</h2>
        <div className="flex justify-center mb-8">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <blockquote className="text-xl md:text-2xl italic text-gray-200 mb-8">
          "CodeForge delivered an exceptional AI chatbot that increased our customer engagement by 300%. Their technical expertise and attention to detail is unmatched."
        </blockquote>
        <div>
      ...
      <section id="contact" className="max-w-6xl mx-auto py-20 px-4">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-2">Get In Touch</h2>
        <div className="flex justify-center mb-8">
          <span className="block w-16 h-1 bg-[#FF7E3F] rounded"></span>
        </div>
        <div className="flex flex-col md:flex-row gap-12">
          {/* Форма */}
          <form className="bg-[#181E36] rounded-xl p-8 flex-1 shadow flex flex-col gap-6">
            ...
            <button type="submit" className="bg-[#FF7E3F] hover:bg-[#ff965f] text-white font-semibold px-8 py-3 rounded-lg text-lg shadow transition-all duration-200 mt-2">Send Message</button>
          </form>
          {/* Контакты */}
